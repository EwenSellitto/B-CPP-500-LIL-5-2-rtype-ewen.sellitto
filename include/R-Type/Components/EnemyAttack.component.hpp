    ...
    struct EnemyAttackComponent : public ECS::BaseComponent {
        public:
            ...
            static ECS::BaseComponent *deserialize(std::vector<char> vec, ECS::BaseComponent *component = nullptr) {
                ...
                iss.read(reinterpret_cast<char*>(&enemyAttack->bulletDestination.x), sizeof(enemyAttack->bulletDestination.x));
                iss.read(reinterpret_cast<char*>(&enemyAttack->bulletDestination.y), sizeof(enemyAttack->bulletDestination.y));
