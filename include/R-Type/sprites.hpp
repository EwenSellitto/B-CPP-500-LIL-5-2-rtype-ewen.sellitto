...
static const std::map<std::string, SpriteInfo> spriteInfoMap = {
    ...
    {"Klaed-Battlecruiser-Base", {"./assets/klaed/Klaed-Battlecruiser-Base.png", 12, 12, 72, 89, 128, 128, 1, 0}},
    ...
    {"Klaed-Dreadnought-Base", {"./assets/klaed/Klaed-Dreadnought-Base.png", 0, 13, 74, 100, 128, 128, 1, 0}},
