    ...
    struct RenderableComponent : public ECS::BaseComponent {
        public:
            ...
            static ECS::BaseComponent *deserialize(std::vector<char> vec, ECS::BaseComponent *component = nullptr) {
                ...
                iss.read(reinterpret_cast<char*>(&renderableComponent->position.x), sizeof(renderableComponent->position.x));
                iss.read(reinterpret_cast<char*>(&renderableComponent->position.y), sizeof(renderableComponent->position.y));
                iss.read(reinterpret_cast<char*>(&renderableComponent->priority), sizeof(renderableComponent->priority));
                iss.read(reinterpret_cast<char*>(&renderableComponent->rotation), sizeof(renderableComponent->rotation));
                ...
                iss.read(reinterpret_cast<char*>(&renderableComponent->isDisplayed), sizeof(renderableComponent->isDisplayed));
